...
- New eval cases in [evals/behavior-cases.json](evals/behavior-cases.json) must map to a rule in [evals/profile.md](evals/profile.md); spot-check them with `node scripts/run-evals.mjs --cases <id>`.
